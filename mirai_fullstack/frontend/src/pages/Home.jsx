...
import { useOverview, useBlogPosts, useFAQs } from '../api'
...
function Hero() {
  return (
    <section
      ...
      style={{ background: 'linear-gradient(145deg, #2D1210 0%, #6B2522 40%, #AA4A44 80%, #8B5E3C 100%)', paddingTop: 80 }}
    >
...
export default function Home() {
  ...
  const { data: blogData }            = useBlogPosts({ page_size: 3 })
